<template lang="html">
  <v-layout justify-center>
    <v-flex>
      <v-card color="rgba(255,255,255,0.0)" flat>
        <v-container fluid grid-list-xl>
          <v-layout wrap>
            <v-flex v-for="card in datos" xs12 :key="card.title" md4 sm6>
              <v-hover>
                <v-card
                  slot-scope="{
                    hover
                ...
                >
                    ...
                    <v-container fill-height fluid pa-2>
                      <v-layout fill-height>
                        <v-flex xs12 align-top flexbox>
                          <span class="headline white--text box_pad">{{
                            card.title
                          }}</span>
                        </v-flex>
                        <v-flex
                        ...
                        >
                          <v-card-text style="height: 88%; position: relative;">
                            <v-tooltip
                              left
                  ...
                  <v-card-title class="justify-center pa-1">
                    Promoción ${{ card.precio.año }}/anual (${{
                      card.precio.año / 12
                    }}mes)
                    <v-tooltip bottom>
